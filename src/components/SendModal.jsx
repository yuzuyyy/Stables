...
export default function SendModal({ onClose }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
            <div className="flex items-center justify-center w-fit p-1 bg-gradient-to-r from-yellow via-blue to-green rounded-xl">
                <motion.div
                ...
                >
                    <h2 className="text-lg font-semibold text-white">Send USDC</h2>
             ...
             focus:outline-none focus:ring-2 focus:ring-blue placeholder-text-muted"
                        />
                        <input
                            type="number"
                            placeholder="Amount"
                            className="text-white border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue placeholder-text-muted"
                        />
                    </div>
